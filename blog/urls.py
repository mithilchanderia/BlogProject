...
urlpatterns = [
    ...
    path('newpost/',views.CreatePostView.as_view(),name='post_new'),
    path('post/new/<pk>/edit/',views.PostUpdateView.as_view(),name='post_edit'),
    path('post/new/<pk>/remove/',views.PostDeleteView.as_view(),name='post_remove'),
